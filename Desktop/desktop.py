...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.verticalLayoutWidget_2.setGeometry(QtCore.QRect(0, 299, 91, 61))
        ...
        self.lcd_pos = QtWidgets.QLCDNumber(self.verticalLayoutWidget_2)
        self.lcd_pos.setStyleSheet("background-color: rgb(206, 206, 206);\n"
